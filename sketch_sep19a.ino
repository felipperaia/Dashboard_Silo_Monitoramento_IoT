...
const char* ID_CLIENTE_MQTT = "idcliente_aqui";  // exemplo: "channels/3093339/publish/XYZ"
const char* USUARIO_MQTT    = "usuarioMQTT_aqui"; // normalmente ID curto fornecido pela plataforma
const char* SENHA_MQTT      = "sua_senhaMQTT_aqui";   // senha/token MQTT
...
float UMID_MINIMA       = 45.0f;  // umidade mínima aceitável em %
